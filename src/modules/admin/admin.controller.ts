...
import { asyncHandler, contractAsyncHandler } from '@/core/asyncHandler';
import {
  paginationMeta,
  // sendCreated,
  sendOk,
...
export const listUsers = contractAsyncHandler<listUsersContract>(async (req, res) => {
  const q = req.query;

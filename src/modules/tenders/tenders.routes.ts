...
import { IdParamSchema } from '../admin/admin.dto';
...
import { tenderUpload } from '@/middleware/upload';
...
router.get('/', controller.getTenders);
router.get(
  '/:id',
  // requirePermission(TenderPermissions.VIEW.key),
  validate(IdParamSchema, 'params'),
  controller.getTenderById,
);
...
router.post(
  ...
  tenderUpload.array('documents'),
  validate(CreateTenderSchema, 'body'),
...
router.put(
  ...
  tenderUpload.array('documents'),
  validate(IdParamSchema, 'params'),
  validate(UpdateTenderSchema, 'body'),

...
export class Tender1789474842796 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "tenders" ADD "deadline" TIMESTAMP WITH TIME ZONE NOT NULL',
    );
    ...
    await queryRunner.query(
      'ALTER TABLE "tenders" ADD CONSTRAINT "FK_88e7ca70fde639f001afed0e3e3" FOREIGN KEY ("country_id") REFERENCES "countries"("id") ON DELETE RESTRICT ON UPDATE NO ACTION',
    );
    await queryRunner.query(
      'ALTER TABLE "tenders" ADD CONSTRAINT "FK_6e36274650292391f6ff9c36da4" FOREIGN KEY ("state_id") REFERENCES "states"("id") ON DELETE RESTRICT ON UPDATE NO ACTION',
    );
    await queryRunner.query(
      'ALTER TABLE "tenders" ADD CONSTRAINT "FK_722dfed60c7c20893d7e908c6ac" FOREIGN KEY ("category_id") REFERENCES "categories"("id") ON DELETE RESTRICT ON UPDATE NO ACTION',
    );
    await queryRunner.query(
      'ALTER TABLE "tenders" ADD CONSTRAINT "FK_bce1779e98be9e8d90937c9c8b3" FOREIGN KEY ("created_by_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION',
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "tenders" DROP CONSTRAINT "FK_722dfed60c7c20893d7e908c6ac"',
    );
    await queryRunner.query(
      'ALTER TABLE "tenders" DROP CONSTRAINT "FK_6e36274650292391f6ff9c36da4"',
    );
    await queryRunner.query(
      'ALTER TABLE "tenders" DROP CONSTRAINT "FK_88e7ca70fde639f001afed0e3e3"',
    );

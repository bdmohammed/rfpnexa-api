...
export class Tender1789459348132 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "tender_documents" DROP CONSTRAINT "FK_58b64cce5db96c5cca8c7f27b73"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tenders" ADD "status" character varying(50) NOT NULL DEFAULT 'ACTIVE'`);
        ...
        await queryRunner.query(`ALTER TABLE "tender_documents" ADD "virus_scan_status" character varying(50) NOT NULL DEFAULT 'Pending'`);
        await queryRunner.query(`ALTER TABLE "tender_documents" ADD "checksum" character varying(64)`);
        await queryRunner.query(`ALTER TABLE "tender_documents" ADD "uploaded_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "tender_documents" ADD "uploaded_by_id" uuid`);
        await queryRunner.query(`ALTER TABLE "tender_documents" ADD "download_count" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "tender_documents" ADD "is_public" boolean NOT NULL DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "tender_documents" ADD "version" integer NOT NULL DEFAULT '1'`);
        await queryRunner.query(`ALTER TABLE "tender_documents" ADD "tender_version_id" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "tender_documents" ADD CONSTRAINT "FK_58b64cce5db96c5cca8c7f27b73" FOREIGN KEY ("uploaded_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

...
export class Initial1784899270693 implements MigrationInterface {
  name = 'Initial1784899270693';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE TABLE "evaluation_templates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "code" character varying(30) NOT NULL, "slug" character varying(100) NOT NULL, "name" character varying(100) NOT NULL, "description" text, "default_weight" numeric(5,2) NOT NULL DEFAULT \'0\', "max_score" integer NOT NULL DEFAULT \'100\', "display_order" integer NOT NULL DEFAULT \'0\', "is_active" boolean NOT NULL DEFAULT true, "created_by" uuid NOT NULL, "updated_by" uuid, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_42e5ce691d135967b6f9050ac36" UNIQUE ("code"), CONSTRAINT "UQ_7f005152bbe44441ccf4f0b2678" UNIQUE ("slug"), CONSTRAINT "UQ_bf334d354b5fd5ebbced3c8f01d" UNIQUE ("name"), CONSTRAINT "CHK_d96c80aca0b09ea983ec3e4392" CHECK ("code" ~ \'^[A-Z0-9_-]+$\'), CONSTRAINT "CHK_c150707b86c15cf5d923cf89ce" CHECK ("slug" ~ \'^[a-z0-9]+(?:-[a-z0-9]+)*$\'), CONSTRAINT "CHK_a4638e6576f9688489945a3bff" CHECK ("max_score" > 0), CONSTRAINT "CHK_e7735caeffe8e514c5a75d8fde" CHECK ("default_weight" <= 100), CONSTRAINT "CHK_6ba5c1c800621b368a299950a6" CHECK ("default_weight" >= 0), CONSTRAINT "PK_2922d6b4a67b6ced60cec793380" PRIMARY KEY ("id"))',
    );
    await queryRunner.query(
    ...
    await queryRunner.query('CREATE INDEX "idx_export_jobs_user_id" ON "export_jobs" ("user_id") ');
    ...
    await queryRunner.query(
      "CREATE TYPE \"public\".\"security_logs_event_enum\" AS ENUM('LOGIN_SUCCESS', 'user_login', 'LOGIN_FAILED', 'LOGOUT', 'PASSWORD_RESET_REQUESTED', 'PASSWORD_RESET_COMPLETED', 'PASSWORD_CHANGED', 'MFA_ENABLED', 'MFA_DISABLED', 'MFA_FAILED', 'ACCOUNT_LOCKED', 'ACCOUNT_UNLOCKED', 'TOKEN_REFRESHED', 'UNAUTHORIZED_ACCESS', 'SUSPICIOUS_ACTIVITY', 'TWO_FACTOR_ENABLED', 'TWO_FACTOR_DISABLED', 'PROFILE_UPDATED', 'ACCOUNT_DEACTIVATED', 'ACCOUNT_REACTIVATED', 'ACCOUNT_DELETE_REQUESTED', 'RESEND_VERIFICATION_SUCCESS', 'REGISTER_SUCCESS', 'CAPTCHA_FAILED', 'PASSWORD_CHANGE', 'EMAIL_CHANGE_REQUEST', 'EMAIL_CHANGE_SUCCESS', 'EMAIL_CHANGE_VERIFY', 'ADMIN_REGISTER_SUCCESS')",
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE TABLE "user_sessions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "token_hash" character varying(255) NOT NULL, "expires_at" TIMESTAMP WITH TIME ZONE NOT NULL, "user_agent" character varying(255), "ip_address" inet, "is_revoked" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_6596adb3b8927b35bda97e734aa" UNIQUE ("token_hash"), CONSTRAINT "PK_e93e031a5fed190d4789b6bfd83" PRIMARY KEY ("id"))',
    );
    await queryRunner.query(
